# Formulário atual — Pesquisa Gente Daqui

## Apresentação

**Título:** Gente Daqui — pesquisa rápida
...
Antes das perguntas, o formulário solicita:
...
### 3. Hoje, qual dessas frases mais combina com você?
...
### 4. Nos últimos 6 meses, você ficou sabendo de algum curso, capacitação, vaga ou programa gratuito perto do seu bairro?
...
### 5. O que pesa na hora de decidir se vale a pena participar de uma oportunidade?
...
### 8. Pensando na área que você marcou, para dar o primeiro passo, o que mais te ajudaria hoje?

_Tipo: múltipla escolha, escolha única. Obrigatória._
...
### 9. E para isso acontecer, quanto tempo você toparia se preparar antes de começar a ganhar dinheiro nessa área?
...
### 10. Você conhece alguém do seu bairro que conseguiu um emprego bom, formalizou o próprio negócio ou entrou numa formação que valeu a pena?

- Sim, conheço bem essa pessoa;
- Conheço de vista, mas não converso;
- Não conheço ninguém assim.

### 11. Se você tem alguém como referência, qual é o nome ou apelido dessa pessoa e em que profissão ou área ela trabalha?
...
O Gente Daqui é uma proposta para aproximar jovens do bairro de oportunidades reais de trabalho e renda. A ideia é:

- Mostrar caminhos e áreas profissionais que podem fazer sentido para você;
- Conectar você a mentores do próprio bairro que já passaram por experiências parecidas;
- Promover orientação entre pares: conversas práticas para tirar dúvidas e entender os próximos passos;
...
Ao final, o participante precisa concordar com o seguinte texto:
...
## Observação para a reformulação

Este documento registra a versão atual do formulário e pode ser usado como base para revisar a clareza das perguntas, a ordem dos assuntos e as alternativas de resposta antes da divulgação definitiva da campanha.
